  ...
  return (
    <div className="bg-atmosphere relative min-h-screen text-[var(--foreground)]">
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col px-6 py-8 sm:px-16">
        {/* Header */}
        <header className="mb-16 flex items-center justify-between border-b border-[rgba(122,173,160,0.06)] pb-6">
          <Link href="/" className="group flex items-center gap-4">
            <div className="flex h-11 w-11 items-center justify-center rounded-full border border-[rgba(122,173,160,0.20)] bg-[rgba(122,173,160,0.04)] text-sm text-[var(--jade)] shadow-[0_0_24px_rgba(122,173,160,0.06)] transition-all duration-500 group-hover:border-[rgba(122,173,160,0.35)] group-hover:shadow-[0_0_32px_rgba(122,173,160,0.10)]">
              爻
            </div>
            <div>
              <div className="font-display text-base tracking-[0.35em] text-[var(--silver)] uppercase">{messages.brand.name}</div>
        ...
        {/* Footer */}
        <footer className="mt-24 border-t border-[rgba(122,173,160,0.06)] pt-8 pb-4">
